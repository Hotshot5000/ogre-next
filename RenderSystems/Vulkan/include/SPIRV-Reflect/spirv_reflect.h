...
namespace spv_reflect
{
    ...
    */
    ...
    public:
        ...
        const SpvReflectDescriptorBinding *GetEntryPointDescriptorBinding(
            const char *entry_point, uint32_t binding_number, uint32_t set_number,
        ...
        const SpvReflectBlockVariable *GetPushConstantBlock(
            uint32_t index, SpvReflectResult *p_result = nullptr ) const;
    ...
    */
    ...
    {
        m_result =
            spvReflectCreateShaderModule( code.size() * sizeof( uint32_t ), code.data(), &m_module );
    }
    ...
    */
    ...
    {
        m_result = spvReflectEnumerateEntryPointDescriptorBindings( &m_module, entry_point, p_count,
                                                                    pp_bindings );
        return m_result;
    }
    ...
    */
    ...
    {
        m_result =
            spvReflectEnumerateEntryPointDescriptorSets( &m_module, entry_point, p_count, pp_sets );
        return m_result;
    }
    ...
    */
    ...
    {
        m_result =
            spvReflectEnumerateEntryPointInputVariables( &m_module, entry_point, p_count, pp_variables );
        return m_result;
    }
    ...
    */
    inline SpvReflectResult ShaderModule::EnumerateEntryPointOutputVariables(
        const char *entry_point, uint32_t *p_count, SpvReflectInterfaceVariable **pp_variables ) const
    {
        m_result = spvReflectEnumerateEntryPointOutputVariables( &m_module, entry_point, p_count,
                                                                 pp_variables );
        return m_result;
    }
    ...
    */
    inline SpvReflectResult ShaderModule::EnumerateEntryPointPushConstantBlocks(
        const char *entry_point, uint32_t *p_count, SpvReflectBlockVariable **pp_blocks ) const
    {
        m_result = spvReflectEnumerateEntryPointPushConstantBlocks( &m_module, entry_point, p_count,
                                                                    pp_blocks );
        return m_result;
    }
    ...
    */
    ...
    {
        return spvReflectGetEntryPointDescriptorBinding( &m_module, entry_point, binding_number,
                                                         set_number, p_result );
    }
    ...
    */
    ...
    {
        return spvReflectGetEntryPointInputVariableByLocation( &m_module, entry_point, location,
                                                               p_result );
    }
    ...
    {
        return spvReflectGetEntryPointInputVariableBySemantic( &m_module, entry_point, semantic,
                                                               p_result );
    }
    ...
    */
    inline const SpvReflectInterfaceVariable *ShaderModule::GetEntryPointOutputVariableByLocation(
        const char *entry_point, uint32_t location, SpvReflectResult *p_result ) const
    {
        return spvReflectGetEntryPointOutputVariableByLocation( &m_module, entry_point, location,
                                                                p_result );
    }
    inline const SpvReflectInterfaceVariable *ShaderModule::GetEntryPointOutputVariableBySemantic(
        const char *entry_point, const char *semantic, SpvReflectResult *p_result ) const
    {
        return spvReflectGetEntryPointOutputVariableBySemantic( &m_module, entry_point, semantic,
                                                                p_result );
    }
    ...
    */
    inline SpvReflectResult ShaderModule::ChangeDescriptorBindingNumbers(
        ...
        uint32_t new_set_number )
    {
        return spvReflectChangeDescriptorBindingNumbers( &m_module, p_binding, new_binding_number,
                                                         new_set_number );
    }
