...
namespace Demo
{
    RayTracedShadowsGameState::RayTracedShadowsGameState(
    ...
    //-----------------------------------------------------------------------------------
    void RayTracedShadowsGameState::createScene01()
    {
...
//        mScreenSpaceReflections = 0;
    ...
    //-----------------------------------------------------------------------------------
    void RayTracedShadowsGameState::update( float timeSinceLast )
    {
        if( mAnimateObjects )
        {
            for( int i = 0; i < 16; ++i )
...
//        mScreenSpaceReflections->update( mGraphicsSystem->getCamera() );
    ...
    //-----------------------------------------------------------------------------------
    void RayTracedShadowsGameState::generateDebugText( float timeSinceLast, Ogre::String &outText )
    {
...
//-----------------------------------------------------------------------------------
    void RayTracedShadowsGameState::setTransparencyToMaterials()
    {
        Ogre::HlmsManager *hlmsManager = mGraphicsSystem->getRoot()->getHlmsManager();
    ...
    //-----------------------------------------------------------------------------------
    void RayTracedShadowsGameState::keyReleased( const SDL_KeyboardEvent &arg )
    {
